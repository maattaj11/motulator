...
# %%
class GridConverterIdentification(Model):
    """
    Continuous-time model for grid converter output admittance identification
    ...
    def __init__(
            self, converter=None, ac_filter=None, ac_source=None, delay=0):
